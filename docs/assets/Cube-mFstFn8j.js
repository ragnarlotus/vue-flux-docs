import{g as _,E as r,i as g,o as a,c as i,a as u,u as o,b as t,H as f,J as v,F as h,q as D,C as b,_ as x}from"./app-pGooBgpL.js";import{P as m}from"./prism-cS1PeyxU.js";import{m as C}from"./slider-tqbc3ZTj.js";import{l as V}from"./vue-flux--F8xa8iS.js";import j from"./Demo-nlpFG_1z.js";import{d as w,f as R,e as S}from"./constants-vSRoptby.js";import"./Images-0G4Yedb4.js";const T={class:"demo"},k=t("h3",null,"Options",-1),B=t("span",null,"Total duration:",-1),E=t("span",null,"Easing:",-1),H=t("h3",null,"Source",-1),L={class:"language-javascript","data-ext":"js"},M=["innerHTML"],y=_({__name:"Cube",setup(F){const p={autohideTime:0},s=r([{component:V,options:r({totalDuration:1400,easing:"ease-out"})}]),c={preloader:!0,controls:!0},d=g(()=>{let l=`
import {
	Cube,
} from 'vue-flux';
