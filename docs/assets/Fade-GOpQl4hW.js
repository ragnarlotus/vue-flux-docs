import{g as _,E as r,i as g,o as n,c as i,a as u,u as o,b as t,H as f,J as v,F as h,q as D,C as x,_ as F}from"./app-zCTnd8Wc.js";import{P as m}from"./prism-cS1PeyxU.js";import{m as V}from"./slider-DmM7sOKr.js";import{U as j}from"./vue-flux-aT5qPPFS.js";import w from"./Demo-j09rccKv.js";import{d as R,f as S,e as T}from"./constants-vSRoptby.js";import"./Images-pD6-27jP.js";const U={class:"demo"},b=t("h3",null,"Options",-1),k=t("span",null,"Total duration:",-1),B=t("span",null,"Easing:",-1),E=t("h3",null,"Source",-1),H={class:"language-javascript","data-ext":"js"},L=["innerHTML"],M=_({__name:"Fade",setup(y){const p={autohideTime:0},s=r([{component:j,options:r({totalDuration:1200,easing:"ease-in"})}]),c={preloader:!0,controls:!0},d=g(()=>{let l=`
import {
	Fade,
} from 'vue-flux';
