import{_ as s,o as n,c as a,e as t}from"./app-9q7i-DDF.js";const e={},o=t(`<h1 id="fluxwrapper" tabindex="-1"><a class="header-anchor" href="#fluxwrapper" aria-hidden="true">#</a> FluxWrapper</h1><h2 id="description" tabindex="-1"><a class="header-anchor" href="#description" aria-hidden="true">#</a> Description</h2><p>A wrapper component for special needs like in some transitions. Sets CSS style <code>overflow</code> as <code>hidden</code> by default.</p><h2 id="methods" tabindex="-1"><a class="header-anchor" href="#methods" aria-hidden="true">#</a> Methods</h2><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token comment">// Set CSS styles to the cube</span>
...
</code></pre></div><h2 id="slots" tabindex="-1"><a class="header-anchor" href="#slots" aria-hidden="true">#</a> Slots</h2><table><thead><tr><th>Name</th><th>Description</th></tr></thead><tbody><tr><td></td><td>This component has a default slot to place anything you need within</td></tr></tbody></table>`,7),p=[o];function c(i,r){return n(),a("div",null,p)}const l=s(e,[["render",c],["__file","index.html.vue"]]);export{l as default};
