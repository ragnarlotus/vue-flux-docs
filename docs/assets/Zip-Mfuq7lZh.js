import{g,E as u,i as _,o as i,c as a,a as n,u as o,b as s,H as f,J as v,F as x,q as V,C as y,_ as T}from"./app-zCTnd8Wc.js";import{P as m}from"./prism-cS1PeyxU.js";import{m as r}from"./slider-DmM7sOKr.js";import{t as b}from"./vue-flux-aT5qPPFS.js";import h from"./Demo-j09rccKv.js";import{m as S,a as j,b as Z,c as w,e as R}from"./constants-vSRoptby.js";import"./Images-pD6-27jP.js";const U={class:"demo"},$=s("h3",null,"Options",-1),k=s("span",null,"Columns:",-1),B=s("span",null,"Tile duration:",-1),C=s("span",null,"Tile delay:",-1),E=s("span",null,"Easing:",-1),H=s("h3",null,"Source",-1),L={class:"language-javascript","data-ext":"js"},M=["innerHTML"],F=g({__name:"Zip",setup(J){const d={autohideTime:0},e=u([{component:b,options:u({cols:10,tileDuration:600,tileDelay:80,easing:"ease-in"})}]),c={preloader:!0,controls:!0},D=_(()=>{let p=`
import {
	Zip,
} from 'vue-flux';
