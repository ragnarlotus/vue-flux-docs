import{_ as s,r as t,o as p,c as o,b as e,d as n,a as c,w as u,e as l}from"./app-zCTnd8Wc.js";const i={},k=l(`<h1 id="fluxcaption" tabindex="-1"><a class="header-anchor" href="#fluxcaption" aria-hidden="true">#</a> FluxCaption</h1><h2 id="description" tabindex="-1"><a class="header-anchor" href="#description" aria-hidden="true">#</a> Description</h2><p>The included component to display resource captions.</p><h2 id="props" tabindex="-1"><a class="header-anchor" href="#props" aria-hidden="true">#</a> Props</h2><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Props</span> <span class="token punctuation">{</span>
