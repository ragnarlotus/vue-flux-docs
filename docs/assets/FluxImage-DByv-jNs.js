import{f as b,g as h,h as f,o as S,c as _,a as n,u as e,b as o,H as p,L as g,d as w,_ as I}from"./app-f_FCzlUc.js";import{R as V,b as U,i as $}from"./vue-flux-XHwbH0Ez.js";import{P as v}from"./prism-cS1PeyxU.js";import{m as d}from"./slider-pQflgib0.js";import{I as k}from"./Images-P-QdXgH-.js";const H={class:"demo"},j=o("h3",null,"Playground",-1),F=o("span",null,"Size width:",-1),L=o("span",null,"Size height:",-1),M={class:"checkbox"},P=o("span",null,"View size width:",-1),T=o("span",null,"View size height:",-1),y={class:"checkbox"},B=o("span",null,"Offset top:",-1),E=o("span",null,"Offset left:",-1),N=o("h3",null,"Source",-1),O={class:"language-javascript","data-ext":"js"},C=["innerHTML"],A={class:"language-html","data-ext":"html"},D=["innerHTML"],J=b({__name:"FluxImage",setup(R){const x=k.generate(1),a=new V({width:640,height:360}),m=h(!1),s=new V({width:640,height:360}),r=h(!1),i=new U({top:0,left:0}),z=f(()=>{let u=`
import {
	Img,
	Size,
	Position,
