import{g as _,E as l,i as g,o as a,c as i,a as u,u as o,b as t,H as f,J as v,F as h,q as D,C as b,_ as x}from"./app-6THF0TDW.js";import{P as m}from"./prism-cS1PeyxU.js";import{m as V}from"./slider-Bf20jKdu.js";import{J as j}from"./vue-flux-P32zUH6D.js";import K from"./Demo-8OeeziKn.js";import{d as w,f as J,e as R}from"./constants-vSRoptby.js";import"./Images-07XQOKXj.js";const S={class:"demo"},T=t("h3",null,"Options",-1),k=t("span",null,"Total duration:",-1),B=t("span",null,"Easing:",-1),E=t("h3",null,"Source",-1),H={class:"language-javascript","data-ext":"js"},L=["innerHTML"],M=_({__name:"Kenburn",setup(y){const p={autohideTime:0},n=l([{component:j,options:l({totalDuration:1500,easing:"linear"})}]),c={preloader:!0,controls:!0},d=g(()=>{let r=`
import {
	Kenburn,
} from 'vue-flux';
