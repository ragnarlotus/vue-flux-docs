import{g as x,E as u,i as g,o as a,c as r,a as t,u as o,b as n,H as f,J as V,F as _,q as v,B as w,_ as y}from"./app-k9p8jFez.js";import{P as m}from"./prism-cS1PeyxU.js";import{m as i}from"./slider-YGWCqJM_.js";import{w as T}from"./vue-flux-EKi73fdj.js";import E from"./Demo-cznZcEo2.js";import{m as b,a as S,b as j,c as R,e as U}from"./constants-vSRoptby.js";import"./Images-emnYdbkt.js";const $={class:"demo"},B=n("h3",null,"Options",-1),h=n("span",null,"Rows:",-1),k=n("span",null,"Columns:",-1),H=n("span",null,"Tile duration:",-1),L=n("span",null,"Tile delay:",-1),M=n("span",null,"Easing:",-1),C=n("h3",null,"Source",-1),F={class:"language-javascript","data-ext":"js"},J=["innerHTML"],N=x({__name:"Explode",setup(P){const d={autohideTime:0},l=u([{component:T,options:u({rows:0,cols:9,tileDuration:300,tileDelay:100,easing:"linear"})}]),c={preloader:!0,controls:!0},D=g(()=>{let p=`
import {
	Explode,
} from 'vue-flux';
