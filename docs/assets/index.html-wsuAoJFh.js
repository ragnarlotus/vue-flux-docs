import{_ as n,o as s,c as a,e as t}from"./app-6THF0TDW.js";const p={},o=t(`<h1 id="fluxcontrols" tabindex="-1"><a class="header-anchor" href="#fluxcontrols" aria-hidden="true">#</a> FluxControls</h1><h2 id="description" tabindex="-1"><a class="header-anchor" href="#description" aria-hidden="true">#</a> Description</h2><p>The included component to display controls with the buttons previous, next, play and pause.</p><h2 id="props" tabindex="-1"><a class="header-anchor" href="#props" aria-hidden="true">#</a> Props</h2><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Props</span> <span class="token punctuation">{</span>
...
</code></pre></div><h3 id="mouseover" tabindex="-1"><a class="header-anchor" href="#mouseover" aria-hidden="true">#</a> mouseOver</h3><p>A reactive parameter to indicate when the mouse is over so it should be displayed.</p><p>If this parameter is not passed, controls will be displayed constantly.</p><h3 id="player" tabindex="-1"><a class="header-anchor" href="#player" aria-hidden="true">#</a> player</h3><p>The player controller. You can get it from <a href="../components/vue-flux#methods">VueFlux</a></p><h4 id="example-of-usage" tabindex="-1"><a class="header-anchor" href="#example-of-usage" aria-hidden="true">#</a> Example of usage</h4><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> ref<span class="token punctuation">,</span> shallowReactive <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&#39;vue&#39;</span><span class="token punctuation">;</span>
