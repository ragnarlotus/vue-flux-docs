import{g as _,E as r,i as g,o as a,c as i,a as u,u as o,b as t,H as f,J as v,F as h,q as D,C as S,_ as x}from"./app-pGooBgpL.js";import{P as m}from"./prism-cS1PeyxU.js";import{m as V}from"./slider-tqbc3ZTj.js";import{q as j}from"./vue-flux--F8xa8iS.js";import w from"./Demo-nlpFG_1z.js";import{d as R,f as T,e as b}from"./constants-vSRoptby.js";import"./Images-0G4Yedb4.js";const k={class:"demo"},q=t("h3",null,"Options",-1),B=t("span",null,"Total duration:",-1),E=t("span",null,"Easing:",-1),H=t("h3",null,"Source",-1),L={class:"language-javascript","data-ext":"js"},M=["innerHTML"],y=_({__name:"Slide",setup(C){const p={autohideTime:0},s=r([{component:j,options:r({totalDuration:1400,easing:"ease-in-out"})}]),c={preloader:!0,controls:!0},d=g(()=>{let l=`
import {
	Slide,
} from 'vue-flux';
