import{g,E as m,i as _,o as s,c as a,a as l,u as o,b as i,H as f,J as v,F as x,q as V,C as y,_ as T}from"./app-6THF0TDW.js";import{P as p}from"./prism-cS1PeyxU.js";import{m as r}from"./slider-Bf20jKdu.js";import{n as C}from"./vue-flux-P32zUH6D.js";import b from"./Demo-8OeeziKn.js";import{m as h,a as S,b as j,c as w,e as R}from"./constants-vSRoptby.js";import"./Images-07XQOKXj.js";const U={class:"demo"},$=i("h3",null,"Options",-1),k=i("span",null,"Circles:",-1),B=i("span",null,"Tile duration:",-1),E=i("span",null,"Tile delay:",-1),H=i("span",null,"Easing:",-1),L=i("h3",null,"Source",-1),M={class:"language-javascript","data-ext":"js"},F=["innerHTML"],J=g({__name:"Concentric",setup(N){const c={autohideTime:0},e=m([{component:C,options:m({circles:7,tileDuration:800,tileDelay:150,easing:"linear"})}]),d={preloader:!0,controls:!0},D=_(()=>{let u=`
import {
	Concentric,
} from 'vue-flux';
