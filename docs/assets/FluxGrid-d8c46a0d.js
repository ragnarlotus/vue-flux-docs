import{F as p,d as _}from"./vue-flux-a0dba35f.js";import{P as r}from"./prism-5c0d5a27.js";import{m as d}from"./slider-48c4d421.js";import{I as x}from"./Images-80560c64.js";import{g as f,h as m,i as v,o as w,c as V,a as u,u as o,d as s,_ as z}from"./app-732a0dff.js";const F={class:"demo demo-flux-grid"},S=s("h3",null,"Playground",-1),G=s("span",null,"Width:",-1),H=s("span",null,"Height:",-1),$=s("span",null,"Rows:",-1),j=s("span",null,"Cols:",-1),b=s("h3",null,"Source",-1),I={class:"language-javascript","data-ext":"js"},L=["innerHTML"],M={class:"language-html","data-ext":"html"},T=["innerHTML"],U=f({__name:"FluxGrid",setup(y){const g=x.generate(1),t=new p({width:640,height:360}),n=m(2),a=m(4),c=v(()=>{let i=`
import {
	Img,
	Size,
	FluxGrid
