import{g,E as m,i as V,o as a,c as r,a as t,u as o,b as s,H as _,J as f,F as v,q as x,C as w,_ as y}from"./app-pGooBgpL.js";import{P as p}from"./prism-cS1PeyxU.js";import{m as i}from"./slider-tqbc3ZTj.js";import{m as R}from"./vue-flux--F8xa8iS.js";import T from"./Demo-nlpFG_1z.js";import{m as b,a as S,b as j,c as U,e as $}from"./constants-vSRoptby.js";import"./Images-0G4Yedb4.js";const h={class:"demo"},k=s("h3",null,"Options",-1),B=s("span",null,"Rows:",-1),C=s("span",null,"Columns:",-1),E=s("span",null,"Tile duration:",-1),H=s("span",null,"Tile delay:",-1),L=s("span",null,"Easing:",-1),M=s("h3",null,"Source",-1),F={class:"language-javascript","data-ext":"js"},J=["innerHTML"],N=g({__name:"Round1",setup(P){const d={autohideTime:0},l=m([{component:R,options:m({rows:0,cols:8,tileDuration:800,tileDelay:150,easing:"ease-out"})}]),c={preloader:!0,controls:!0},D=V(()=>{let u=`
import {
	Round1,
} from 'vue-flux';
