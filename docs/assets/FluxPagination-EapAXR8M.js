import{P as t}from"./prism-cS1PeyxU.js";import{K as f,H as F,G as w,Y as C,p as k,o as B,a as b,l as H,r as T,u as j}from"./vue-flux-XHwbH0Ez.js";import I from"./Demo-wMdBEQu_.js";import{I as L}from"./Images-P-QdXgH-.js";import{f as M,E as D,h as n,o as V,c as W,a as l,u as e,b as s,w as r,k as c,n as u,D as R,C as y,_ as S}from"./app-f_FCzlUc.js";const A=s("h2",null,"Default pagination",-1),z=s("h3",null,"Source",-1),E={class:"language-javascript","data-ext":"js"},G=["innerHTML"],J={class:"language-html","data-ext":"html"},K=["innerHTML"],N=s("h2",null,"Custom pagination",-1),Y=["title","onClick"],$=s("h3",null,"Source",-1),q={class:"language-javascript","data-ext":"js"},O=["innerHTML"],Q={class:"language-html","data-ext":"html"},U=["innerHTML"],X={class:"language-scss","data-ext":"scss"},Z=["innerHTML"],ss=M({__name:"FluxPagination",setup(as){const p={autohideTime:0},m={pagination:!0,controls:!0,preloader:!0},g=D([k,B,b,H,T,j]),d=n(()=>{let a=`
import {
	Img,
	FluxPreloader,
	FluxControls,
