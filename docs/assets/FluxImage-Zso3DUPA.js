import{g as b,h,i as p,o as S,c as _,a as n,u as e,b as o,H as f,L as g,d as w,_ as I}from"./app-zCTnd8Wc.js";import{R as V,b as U,i as $}from"./vue-flux-aT5qPPFS.js";import{P as v}from"./prism-cS1PeyxU.js";import{m as d}from"./slider-DmM7sOKr.js";import{I as k}from"./Images-pD6-27jP.js";const H={class:"demo"},j=o("h3",null,"Playground",-1),F=o("span",null,"Size width:",-1),L=o("span",null,"Size height:",-1),M={class:"checkbox"},P=o("span",null,"View size width:",-1),T=o("span",null,"View size height:",-1),y={class:"checkbox"},B=o("span",null,"Offset top:",-1),E=o("span",null,"Offset left:",-1),N=o("h3",null,"Source",-1),O={class:"language-javascript","data-ext":"js"},C=["innerHTML"],A={class:"language-html","data-ext":"html"},D=["innerHTML"],J=b({__name:"FluxImage",setup(R){const x=k.generate(1),a=new V({width:640,height:360}),m=h(!1),s=new V({width:640,height:360}),r=h(!1),i=new U({top:0,left:0}),z=p(()=>{let u=`
import {
	Img,
	Size,
	Position,
...
const offset = new Position({
	top: ${i.top.value},
	left: ${i.left.value},
});`),v.highlight(u.trim(),v.languages.javascript,"javascript")}),c=p(()=>{const u=`
<FluxImage
	:rsc="rsc"
	:size="size"
