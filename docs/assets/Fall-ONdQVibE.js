import{g as _,E as r,i as g,o as e,c as i,a as u,u as o,b as t,H as f,J as v,F as h,q as D,C as x,_ as F}from"./app-zCTnd8Wc.js";import{P as m}from"./prism-cS1PeyxU.js";import{m as V}from"./slider-DmM7sOKr.js";import{k as j}from"./vue-flux-aT5qPPFS.js";import k from"./Demo-j09rccKv.js";import{d as w,f as R,e as S}from"./constants-vSRoptby.js";import"./Images-pD6-27jP.js";const T={class:"demo"},b=t("h3",null,"Options",-1),B=t("span",null,"Total duration:",-1),E=t("span",null,"Easing:",-1),H=t("h3",null,"Source",-1),L={class:"language-javascript","data-ext":"js"},M=["innerHTML"],y=_({__name:"Fall",setup(C){const p={autohideTime:0},s=r([{component:j,options:r({totalDuration:1600,easing:"ease-in"})}]),c={preloader:!0,controls:!0},d=g(()=>{let l=`
import {
	Fall,
} from 'vue-flux';
