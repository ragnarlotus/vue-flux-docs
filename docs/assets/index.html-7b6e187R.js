import{_ as n,o as a,c as s,e as t}from"./app-pGooBgpL.js";const p={},o=t(`<h1 id="fluxpagination" tabindex="-1"><a class="header-anchor" href="#fluxpagination" aria-hidden="true">#</a> FluxPagination</h1><h2 id="description" tabindex="-1"><a class="header-anchor" href="#description" aria-hidden="true">#</a> Description</h2><p>The included component to display a pagination of the resources, good when it does not contain too many.</p><h2 id="props" tabindex="-1"><a class="header-anchor" href="#props" aria-hidden="true">#</a> Props</h2><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">interface</span> <span class="token class-name">Props</span> <span class="token punctuation">{</span>
