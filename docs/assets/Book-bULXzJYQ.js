import{g as _,E as r,i as g,o as e,c as i,a as u,u as o,b as t,H as f,J as v,F as h,q as D,C as k,_ as x}from"./app-pGooBgpL.js";import{P as m}from"./prism-cS1PeyxU.js";import{m as B}from"./slider-tqbc3ZTj.js";import{a as V}from"./vue-flux--F8xa8iS.js";import j from"./Demo-nlpFG_1z.js";import{d as w,f as R,e as S}from"./constants-vSRoptby.js";import"./Images-0G4Yedb4.js";const T={class:"demo"},b=t("h3",null,"Options",-1),E=t("span",null,"Total duration:",-1),H=t("span",null,"Easing:",-1),L=t("h3",null,"Source",-1),M={class:"language-javascript","data-ext":"js"},y=["innerHTML"],C=_({__name:"Book",setup(F){const p={autohideTime:0},s=r([{component:V,options:r({totalDuration:1200,easing:"ease-out"})}]),c={preloader:!0,controls:!0},d=g(()=>{let l=`
import {
	Book,
} from 'vue-flux';
