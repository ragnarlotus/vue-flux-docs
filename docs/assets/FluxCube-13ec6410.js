import{g as z,h as d,i as c,o as h,c as f,a,u as s,d as t,H as I,J as F,F as y,q as H,B as U,p as j,_ as C}from"./app-732a0dff.js";import{F as k,b as L}from"./vue-flux-a0dba35f.js";import{P as v}from"./prism-5c0d5a27.js";import{m as r}from"./slider-48c4d421.js";import{I as M}from"./Images-80560c64.js";import{o as T}from"./constants-e7e525a7.js";const B=t("h3",{style:{"margin-top":"128px"}},"Playground",-1),P=t("span",null,"Width:",-1),D=t("span",null,"Height:",-1),N=t("span",null,"Depth:",-1),X=t("span",null,"Rotate X:",-1),Y=t("span",null,"Rotate Y:",-1),J=t("span",null,"Perspective:",-1),R=t("span",null,"Transform origin:",-1),q=t("h3",null,"Source",-1),A={class:"language-javascript","data-ext":"js"},E=["innerHTML"],O={class:"language-html extra-class"},W=["innerHTML"],G=z({__name:"FluxCube",setup(K){const w=M.generate(6),V=["front","back","top","bottom","left","right"],x={};for(let o=0;o<V.length;o++)x[V[o]]=w[o];const n=new k({width:640,height:360}),m=d(180),p=d(0),g=d(0),i=d(1600),u=d(void 0),_=Object.values(T),b=c(()=>({transform:`rotateX(${p.value}deg) rotateY(${g.value}deg)`})),S=c(()=>{let o=`
import {
	Img,
	Size,
	FluxCube
