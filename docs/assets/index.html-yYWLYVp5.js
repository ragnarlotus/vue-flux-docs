import{_ as n,o as s,c as a,b as e}from"./app-DHB0SMXO.js";const t={},o=e(`<h1 id="img" tabindex="-1"><a class="header-anchor" href="#img" aria-hidden="true">#</a> Img</h1><p>Renders an image</p><h2 id="constructor" tabindex="-1"><a class="header-anchor" href="#constructor" aria-hidden="true">#</a> Constructor</h2><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token function">constructor</span><span class="token punctuation">(</span>
	...
	resizeType<span class="token operator">:</span> ResizeType <span class="token operator">=</span> <span class="token string">&#39;fill&#39;</span>
