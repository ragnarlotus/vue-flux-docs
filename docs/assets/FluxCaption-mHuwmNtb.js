...
const transitions = shallowReactive([
	...
	Warp,
	Wave,
]);`;return s.highlight(t.trim(),s.languages.javascript,"javascript")}),h=n(()=>{const t=`
<VueFlux
	:rscs="rscs"
...
`,""),s.languages.html,"html")});return(t,$)=>(V(),W("div",null,[q,r(I,{transitions:o(u),numRscs:3,complements:g},null,8,["transitions"]),z,e("div",A,[e("pre",{innerHTML:d.value,class:"language-javascript"},null,8,E)]),e("div",J,[e("pre",{innerHTML:h.value,class:"language-html"},null,8,N)]),X,r(o(w),{rscs:o(_),transitions:o(u)},{preloader:l(a=>[r(o(f),c(i(a)),null,16)]),caption:l(a=>[r(o(C),c(i(a)),{default:l(()=>{var p,m;return[e("h3",null,[e("a",{href:v((p=a.currentResource)==null?void 0:p.rsc.caption),target:"_blank"},D((m=a.currentResource)==null?void 0:m.rsc.caption),9,Y)])]}),_:2},1040)]),controls:l(a=>[r(o(P),c(i(a)),null,16)]),_:1},8,["rscs","transitions"]),y,e("div",G,[e("pre",{innerHTML:x.value,class:"language-javascript"},null,8,K)]),e("div",O,[e("pre",{innerHTML:F.value,class:"language-html"},null,8,Q)])]))}}),re=S(U,[["__file","FluxCaption.vue"]]);export{re as default};
