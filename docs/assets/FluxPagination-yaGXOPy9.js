...
`,""),t.languages.css,"css")});return(s,ta)=>(W(),D("div",null,[y,l(M,{options:p,transitions:e(g),complements:m,numRscs:3},null,8,["transitions"]),z,a("div",E,[a("pre",{innerHTML:d.value,class:"language-javascript"},null,8,J)]),a("div",N,[a("pre",{innerHTML:h.value,class:"language-html"},null,8,Y)]),$,l(e(k),{options:p,rscs:e(_),transitions:e(g),class:"flux-custom-pagination"},{preloader:r(o=>[l(e(f),u(c(o)),null,16)]),controls:r(o=>[l(e(F),u(c(o)),null,16)]),pagination:r(o=>[l(e(C),u(c(o)),{default:r(i=>[a("div",{class:R(i.cssClass),title:i.title,onClick:ea=>i.onClick()},S(i.index+1),11,q)]),_:2},1040)]),_:1},8,["rscs","transitions"]),G,a("div",K,[a("pre",{innerHTML:v.value,class:"language-javascript"},null,8,O)]),a("div",Q,[a("pre",{innerHTML:x.value,class:"language-html"},null,8,U)]),a("div",X,[a("pre",{innerHTML:P.value,class:"language-scss"},null,8,Z)])]))}}),ca=A(aa,[["__file","FluxPagination.vue"]]);export{ca as default};
