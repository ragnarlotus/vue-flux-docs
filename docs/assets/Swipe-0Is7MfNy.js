import{g as _,E as r,i as g,o as a,c as i,a as p,u as o,b as t,H as f,J as v,F as h,q as D,C as w,_ as S}from"./app-zCTnd8Wc.js";import{P as u}from"./prism-cS1PeyxU.js";import{m as x}from"./slider-DmM7sOKr.js";import{Z as V}from"./vue-flux-aT5qPPFS.js";import j from"./Demo-j09rccKv.js";import{d as R,f as T,e as b}from"./constants-vSRoptby.js";import"./Images-pD6-27jP.js";const k={class:"demo"},B=t("h3",null,"Options",-1),E=t("span",null,"Total duration:",-1),H=t("span",null,"Easing:",-1),L=t("h3",null,"Source",-1),M={class:"language-javascript","data-ext":"js"},y=["innerHTML"],C=_({__name:"Swipe",setup(F){const m={autohideTime:0},s=r([{component:V,options:r({totalDuration:1400,easing:"ease-in-out"})}]),c={preloader:!0,controls:!0},d=g(()=>{let l=`
import {
	Swipe,
} from 'vue-flux';
