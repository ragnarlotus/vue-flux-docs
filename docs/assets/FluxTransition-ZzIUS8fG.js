...
`,""),d.languages.html,"html")});return(o,e)=>(r(),f("div",me,[c.value?(r(),I(s(G),{key:0,ref_key:"$fluxTransition",ref:x,size:s(n),transition:V.value,from:s(S),to:s(B),onEnd:e[0]||(e[0]=t=>p())},null,8,["size","transition","from","to"])):y("v-if",!0),ce,a("label",null,[pe,u(s(T),{modelValue:s(n).width.value,"onUpdate:modelValue":e[1]||(e[1]=t=>s(n).width.value=t),min:100,max:640,onSlide:e[2]||(e[2]=t=>s(n).width.value=t)},null,8,["modelValue"])]),a("label",null,[ve,u(s(T),{modelValue:s(n).height.value,"onUpdate:modelValue":e[3]||(e[3]=t=>s(n).height.value=t),min:100,max:640,onSlide:e[4]||(e[4]=t=>s(n).height.value=t)},null,8,["modelValue"])]),a("label",null,[h(" Transition: "),j(a("select",{"onUpdate:modelValue":e[5]||(e[5]=t=>l.value=t),onChange:e[6]||(e[6]=t=>p()),style:{"margin-left":"6px"}},[(r(!0),f(N,null,H(s(C),t=>(r(),f("option",{key:t},M(t),1))),128))],544),[[D,l.value]])]),u(k,{onClick:e[7]||(e[7]=t=>z())},{default:w(()=>[h("Run")]),_:1}),u(k,{onClick:e[8]||(e[8]=t=>p())},{default:w(()=>[h("Reset")]),_:1}),ge,a("div",fe,[a("pre",{innerHTML:F.value,class:"language-javascript"},null,8,he)]),a("div",xe,[a("pre",{innerHTML:$.value,class:"language-html"},null,8,_e)])]))}}),ze=J(we,[["__scopeId","data-v-aebe6710"],["__file","FluxTransition.vue"]]);export{ze as default};
