import{g as _,E as r,i as g,o as a,c as i,a as u,u as o,b as t,H as f,J as v,F as h,q as D,B as S,_ as x}from"./app-k9p8jFez.js";import{P as m}from"./prism-cS1PeyxU.js";import{m as V}from"./slider-YGWCqJM_.js";import{g as j}from"./vue-flux-EKi73fdj.js";import w from"./Demo-cznZcEo2.js";import{d as B,f as R,e as T}from"./constants-vSRoptby.js";import"./Images-emnYdbkt.js";const b={class:"demo"},k=t("h3",null,"Options",-1),E=t("span",null,"Total duration:",-1),H=t("span",null,"Easing:",-1),L=t("h3",null,"Source",-1),M={class:"language-javascript","data-ext":"js"},q=["innerHTML"],y=_({__name:"Slide",setup(F){const p={autohideTime:0},s=r([{component:j,options:r({totalDuration:1400,easing:"ease-in-out"})}]),c={preloader:!0,controls:!0},d=g(()=>{let l=`
import {
	Slide,
} from 'vue-flux';
