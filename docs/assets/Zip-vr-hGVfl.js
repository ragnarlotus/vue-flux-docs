import{g,E as u,i as _,o as i,c as a,a as n,u as o,b as s,H as f,J as v,F as x,q as V,B as y,_ as T}from"./app-k9p8jFez.js";import{P as m}from"./prism-cS1PeyxU.js";import{m as r}from"./slider-YGWCqJM_.js";import{t as b}from"./vue-flux-EKi73fdj.js";import h from"./Demo-cznZcEo2.js";import{m as S,a as j,b as Z,c as w,e as B}from"./constants-vSRoptby.js";import"./Images-emnYdbkt.js";const R={class:"demo"},U=s("h3",null,"Options",-1),$=s("span",null,"Columns:",-1),k=s("span",null,"Tile duration:",-1),E=s("span",null,"Tile delay:",-1),H=s("span",null,"Easing:",-1),L=s("h3",null,"Source",-1),M={class:"language-javascript","data-ext":"js"},C=["innerHTML"],F=g({__name:"Zip",setup(J){const d={autohideTime:0},e=u([{component:b,options:u({cols:10,tileDuration:600,tileDelay:80,easing:"ease-in"})}]),c={preloader:!0,controls:!0},D=_(()=>{let p=`
import {
	Zip,
} from 'vue-flux';
